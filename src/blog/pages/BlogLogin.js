...
const BlogLogin = () => {
  ...
  const { logIn, signInWithGoogle, accountIsAvailable } = UserAuth(); // user
  ...
  return (
    <div className="h-screen w-screen flex flex-col justify-center items-center ">
      ...
      >
        ...
        <p className={`${accountIsAvailable ? "block" : "hidden"} ml-14 m-4 mt-0 text-red-500 font-bold w-full text-left`}>Password or Email is wrong</p>
        <div className="w-[90%] flex h-[60px] justify-between items-center">
          <button
            ...
            } w-[48%] h-[60px] mr-1 cursor-pointer`}
          >
            Log In
          </button>
