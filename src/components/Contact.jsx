...
const Contact = () => {
  return (
    <div name='contact' className='w-full min-h-screen  bg-[#0a192f] flex justify-center items-center flex-col p-4'>
        <form method='POST' action="https://getform.io/f/dabafa22-8310-4e87-a6fe-cf1b0cef4fc1" className='flex flex-col max-w-[600px] w-full'>
          ...
          <div className='w-full  grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4 text-center py-8'>
                  ...
                  <div className='py-4 shadow-md shadow-[#040c16] hover:scale-90 duration-500 '>
                      <img className='w-8 mx-auto' src={GitHub} alt="github icon" />
                        <a className='text-white py-4' href="https://github.com/Danialezzat?tab=repositories" target='_blanck'>GitHub</a>
                  </div>
                  <div className='py-4 shadow-md shadow-[#040c16] hover:scale-90 duration-500'>
                      <img className='w-8 mx-auto' src={LinkedIn} alt="github icon" />
                        <a className='text-white' href="https://www.linkedin.com/in/daniel-ezzatmadar-554736197" target='_blanck'>LinkedIn</a>
                  </div>
          </div>
